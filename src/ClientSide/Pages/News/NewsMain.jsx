        ...
        `}
                                    ...
                                    <div className="2xl:w-[485px] xl:w-[380px] newCardGap 2xl:mb-[70px] xl:mb-[57px] 2xl:mr-[82px] xl:mr-[65px] cardGap cardGapRight  shadow-lg ">
                                        ...
                                        <div className="2xl:pb-[28px] xl:pb-[15px] 2xl:pt-[47px] xl:pt-[30px] cardTop">
                                            <button className="text-[#12225D] 2xl:text-[15px] xl:text-[12px] xl:leading-[15px] 2xl:leading-[22.5px] xl:mb-[5px] 2xl:mb-[8px] xl:ml-[15px] 2xl:ml-[20px]  border-b-[1px] border-[#12225D]">READ MORE</button>
                                        </div>
                                    </div>
                                </div>
                                <div>
        ...
        `}
                                ...
                                <div className="2xl:w-[485px] xl:w-[380px] newCardGap 2xl:mb-[70px] mb-[60px] xl:mb-[57px] 2xl:mr-[82px] xl:mr-[65px] cardGap cardGapRight  shadow-lg ">
                                    ...
                                    <div className="2xl:pb-[28px] xl:pb-[15px] pb-[13.26px] 2xl:pt-[47px] xl:pt-[30px] pt-[104px] cardTop">
                                        <button className="text-[#12225D] 2xl:text-[15px] xl:text-[12px]  xl:leading-[15px] 2xl:leading-[22.5px] xl:mb-[5px] 2xl:mb-[8px] mb-[2.72px] xl:ml-[15px] 2xl:ml-[20px] ml-[10px]  border-b-[1px] border-[#12225D] text-[8px] leading-[8px] ">READ MORE</button>
                                    </div>
                                </div>
                            </div>
                        </SwiperSlide>
