...
const Youtube = () => {
    return (
        <div className="lR 2xl:mb-[250px] xl:mb-[200px] 2xl:w-[1620px] xl:w-[1270px] 2xl:h-[927px] xl:h-[751px] mx-auto youTubeHeight">
            <div className="relative" style={{ paddingBottom: "57.22%" }}>
                <iframe
                    className="absolute top-0 left-0 w-full h-full rounded-[44px]"
